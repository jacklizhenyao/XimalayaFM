...
public class NewFragment extends BaseFragment {
    ...
    private MyAlbumAdapter newAdapter;
    private PullToRefreshView pull;
 private  int pageSize;
    private String result;
    private  String url ="http://mobile.ximalaya.com/mobile/discovery/v1/category/album?calcDimension=" +
            "recent&categoryId=0&device=android&pageId=1&pageSize=" +
            pageSize +
            "&status=0&tagName=";
    @Override
 ...
 View view =View.inflate(getActivity(), R.layout.sound_new_fire_fragment,null);
        ...
        newAdapter = new MyAlbumAdapter(list, getContext());
        fragment_fire_lv.setAdapter(newAdapter);
