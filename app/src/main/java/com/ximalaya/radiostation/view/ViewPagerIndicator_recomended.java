...
public class ViewPagerIndicator_recomended extends LinearLayout {
	...
	public ViewPagerIndicator_recomended(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public ViewPagerIndicator_recomended(Context context) {
		this(context,null);
		// TODO Auto-generated constructor stub
	}
