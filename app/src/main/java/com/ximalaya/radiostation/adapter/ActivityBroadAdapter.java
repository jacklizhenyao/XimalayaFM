 ...
 */
public class ActivityBroadAdapter extends BaseAdapter{

    Context context;
    List<ActivityBroad.Datas> list;

    public ActivityBroadAdapter(Context context, List<ActivityBroad.Datas> list) {
    ...
    public void setList(List<ActivityBroad.Datas> list){
        this.list = list;
